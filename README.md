...
v1.5.1（2026-09-24，UI v2 修正版）：修复高 DPI（125% / 150%）下窗口超出屏幕、标题栏过窄、看不到最小化 / 最大化 / 关闭按钮、设置弹窗与分页文字被裁切；修复官网查询页出现两张截图卡片、卡片一直停在“截取中”；表格、分页、搜索框按设计稿对齐。详见 [更新说明](docs/release-notes-v1.5.1.md)。v1.5.0 起的 UI v2 变化见 [v1.5.0 更新说明](docs/release-notes-v1.5.0.md)。
