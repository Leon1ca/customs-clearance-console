...
v1.5.0（2026-09-24，UI v2）：企业工作台界面 v2；点击“校验”后在网页右下角截图卡片上手动保存整页长截图；新增关单明细（商品名称、数量、单位、单价）与 Excel / Markdown 两种导出；修复跨进程页面截图偶发失败或空白，并加强历史数据保存、导出和长时间运行的稳定性。详见 [更新说明](docs/release-notes-v1.5.0.md)。上一版本见 [v1.4.0 更新说明](docs/release-notes-v1.4.0.md)。
